...
public class GetMemberList extends AbstractPKHttpRequest {
    
    public static List<MemberObject> requestMembers(String authToken, String systemID) throws IOException, InterruptedException {
